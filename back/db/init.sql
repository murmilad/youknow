...
END $$;
DO $$ BEGIN
    CREATE TYPE lesson_status AS ENUM ('LESSON_NEW', 'LESSON_STARTED', 'LESSON_PAUSED');
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
CREATE TABLE IF NOT EXISTS lessons (
    know_type_id NOT NULL REFERENCES know_types(id),
    user_id uuid NOT NULL REFERENCES users(id),
    ...
    deleted boolean NOT NULL DEFAULT false,
    PRIMARY KEY (know_type_id, user_id)
);
