...
CREATE TABLE IF NOT EXISTS lessons (
    ...
    lesson_type_handler character varying(255) NOT NULL REFERENCES lesson_types(handler) DEFAULT 'FORGET_CURVE',
    lesson_status lesson_status NOT NULL DEFAULT 'LESSON_PAUSED',
    priority_percent real CHECK (priority_percent BETWEEN 0 AND 100), 
    deleted boolean NOT NULL DEFAULT false,
