...
### Docker auth.docker.io connection refused

Add auth.docker.io pinged from outstairs ip to /etc/hosts

### Docker auth.docker.io EOF

Update auth.docker.io /etc/hosts Ж)))
