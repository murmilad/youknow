...
import { GOOGLE_OAUTH_APP_CLIENT_ID, GOOGLE_APP_OAUTH_REDIRECT_URL } from 'react-native-dotenv';

const config = {
  issuer: 'https://accounts.google.com',
  clientId: GOOGLE_OAUTH_APP_CLIENT_ID,
  redirectUrl: GOOGLE_APP_OAUTH_REDIRECT_URL,
...
function googleAuthorize() {
  ...
  console.log(`GOOGLE_APP_OAUTH_REDIRECT_URL = ${GOOGLE_APP_OAUTH_REDIRECT_URL}`);
